  ...
  do iBlock = 1, 2
     ...
     case(1) ! Northern hemisphere
        ...
        call ionosphere_conductance(IONO_NORTH_Sigma0,               &
             ...
             IONO_NORTH_IDIF_EFlux, IONO_NORTH_IDIF_Ave_E,      &
             IONO_NORTH_BBND_EFlux, IONO_NORTH_BBND_Ave_E,      &
     ...
     case(2) ! Southern hemisphere
        ...
        call ionosphere_conductance(IONO_SOUTH_Sigma0,               &
             ...
             IONO_SOUTH_IDIF_EFlux, IONO_SOUTH_IDIF_Ave_E,      &
             IONO_SOUTH_BBND_EFlux, IONO_SOUTH_BBND_Ave_E,      &
