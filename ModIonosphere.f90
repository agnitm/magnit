...
module ModIonosphere
  ...
  real, allocatable :: IONO_NORTH_IDIF_Ave_E(:,:)
  real, allocatable :: IONO_SOUTH_IDIF_Ave_E(:,:)
  ...
  real, allocatable :: IONO_NORTH_IDIF_EFlux(:,:)
...
contains
  ...
  subroutine init_mod_ionosphere
    ...
    allocate(IONO_NORTH_IDIF_Ave_E(IONO_nTheta,IONO_nPsi))
    allocate(IONO_SOUTH_IDIF_Ave_E(IONO_nTheta,IONO_nPsi))
    ...
    allocate(IONO_NORTH_IDIF_EFlux(IONO_nTheta,IONO_nPsi))
  ...
  subroutine clean_mod_ionosphere
    ...
    deallocate(IONO_NORTH_IDIF_Ave_E)
    deallocate(IONO_SOUTH_IDIF_Ave_E)
    ...
    deallocate(IONO_NORTH_IDIF_EFlux)
